...
**Generating RAG databases:** The `.zip` files used by RAG tools are generated by [orama-persistence-generator](https://github.com/axelseis/orama-persistence-generator). See its README for installation, configuration, and usage.

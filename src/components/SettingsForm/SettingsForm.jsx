...
function SettingsForm() {
  ...
  const handleImageModelChange = (e) => {
    // Mock function for image model selection
    console.log("Selected image model:", e.target.value);
  };
  ...
  // Available image generation models (OpenAI only)
  const availableImageModels = [
    { id: "dall-e-3", name: "DALL-E 3" },
    { id: "dall-e-2", name: "DALL-E 2" },
  ];

  // Mock selected image model (in real implementation, this would come from store)
  const selectedImageModel = "dall-e-3";
